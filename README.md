...
MONGO_URI="your_URL" PORT=8000 SECRET_KEY=jobportal_dev_secret_change_in_production_use_long_random_string

CLOUD_NAME="your_Cloud" API_KEY="your_Api_key" API_SECRET="your_API_SECRET"

🔐 Environment Variables
Backend Variable Required Description PORT No Server port (default: 8000) MONGO_URI Yes MongoDB connection string SECRET_KEY Yes Secret key for authentication (JWT or session) CLOUD_NAME Yes Cloudinary cloud name for media uploads API_KEY Yes Cloudinary API key API_SECRET Yes Cloudinary API secret
